...
private:
    ...
    struct PoolEntry {
        std::unique_ptr<A> asset; ///< @brief The stored asset.
    ...
    struct AssetPoolData {
        ...
        std::vector<Index> free_list;   ///< @brief Indices that have been freed and should be used.
    };
...
public:
    ...
    auto store(const AssetID id, std::unique_ptr<A>&& asset) -> bool {
