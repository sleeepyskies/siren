...
export class AssetServer {
    ...
    struct AssetServerData {
        ...
        sync::RwLock<std::unordered_map<HashedString, AssetInfo>> asset_infos;
        /// @brief Main storage for asset data.
        sync::RwLock<std::unordered_map<TypeID, std::unique_ptr<AssetPoolBase>>> storage{ };
...
public:
    ...
    explicit AssetServer(const AssetConfig& cfg);
